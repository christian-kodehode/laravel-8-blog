...
<link rel="icon" type="image/x-icon" href="https://cdn-icons-png.flaticon.com/512/1069/1069210.png">
        ...
        <nav class="md:flex md:justify-between md:items-center">
            ...
            <div class="mt-8 md:mt-0 flex items-center">
                ...
                <x-dropdown>
                    ...
                    @if (Auth::user()->username!='ctriis')
                        <x-dropdown-item href="/user/dashboard" :active="request()->is('user/dashboard')">Dashboard</x-dropdown-item>
